...
<body>
	...
	<jsp:include page="/include/header.jsp">
		<jsp:param value="Panou de Stergere Discipline" name="title" />
	</jsp:include>
	...
	<div id="content">
		...
		<%
			...
			if(new DisciplinaWrapper().deleteDisciplina("cod='"+request.getParameter("cod")+"'"))
				notify("Stergerea s-a efectuat cu success",out);
			else
				error("A aparut o problema la stergerea disciplinei "+request.getParameter("cod"),out);
		%>
