...
public class RegistruActivitatiDidacticeServer implements RegistruActivitatiDidactice {
	...
	/** The arhiva service. */
	private Arhiva arhivaService=null;
	
	/**
	 * Instantiates a new registru activitati didactice server.
	 */
	public RegistruActivitatiDidacticeServer() {
		super();
	}
	
	/**
	 * Pregateste arhiva service.
	 */
	private void pregatesteArhivaService()
	{
		System.out.println("Initializam serviciul Arhiva");
		try {
			// Prepare the registry to query
			Registry registry = LocateRegistry.getRegistry("localhost");

			// Get the stubs for the remote service
			arhivaService = (Arhiva) registry
					.lookup(Arhiva.PUBLISH_NAME);
	...
	public ArrayList<OrarComplet> obtineOrarComplet(String cnpStudent, String grupa, int semestru) throws RemoteException {
		...
		//Pregatim disciplinele
		ArrayList<Integer> discipline;
		if(arhivaService==null)
			this.pregatesteArhivaService();
		discipline=arhivaService.obtineDisciplineUrmate(cnpStudent, anStudiu, semestru);
	...
	public ArrayList<Examen> obtineProgramareExamene(String cnpStudent, String grupa) throws RemoteException {
		...
		if(arhivaService==null)
			this.pregatesteArhivaService();
		discipline=arhivaService.obtineDisciplineUrmate(cnpStudent, anStudiu);
