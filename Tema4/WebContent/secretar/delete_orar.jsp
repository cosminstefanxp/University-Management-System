...
<body>
	...
	<jsp:include page="/include/header.jsp">
		<jsp:param value="Panou de Stergere Orar" name="title" />
	</jsp:include>
	...
	<div id="content">
		...
		<%
			try{
			new OrarWrapper().deleteObject(Constants.ORAR_TABLE, "id_activitate='" +
					request.getParameter("id_activitate") + "' AND grupa='" + request.getParameter("grupa") + "'");
			notify("Stergerea s-a efectuat cu success",out);
			}
			catch(Exception ex)
			{
				error("A aparut o problema la stergerea orarului: "+ex.getMessage(),out);
			}
		%>
